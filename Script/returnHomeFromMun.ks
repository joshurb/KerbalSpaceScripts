...
function main {
  //testing if I can make a node from the ground.
  SET myNode to NODE( 0, 0, 0, 250 ).
  ADD myNode.



  //doLaunch().
  //TODO: need better launch angle
  //doAscent().
  //no need to stage on the way back.
...
function munTransferScore {
  ...
  if mnv:orbit:periapsis < 75000 {
    print "Bad Kerbin Periapsis, try again: " + orbit:periapsis.
    set result to 2^64.
